import 'package:app/controllers/slider_products_controller.dart';
...
class SliderProductsScreen extends StatelessWidget {
  final int sliderId;
  ...
  Widget build(BuildContext context) {
    final ctrl = Get.put(SliderProductsController(sliderId: sliderId));

    return Scaffold(
      appBar: CustomAppBar(title: sliderTitle ?? 'عروض المنتجات'),
      body: Column(
        children: [
          Obx(
            () => ProductFilterBar(
